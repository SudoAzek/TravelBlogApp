...
public final class BlogHttpClient {
    ...
    public static final String BASE_URL = "https://raw.githubusercontent.com/SudoAzek";
    public static final String PATH = "/TravelBlogApp/main";
    private static final String BLOG_ARTICLES_URL = BASE_URL + PATH + "/app/blog_articles.json";
